...
create and extract zip files</td>
...
copy files to and from a server</td>
...
browse the internet, including Firefox Sync for synchronizing passwords, bookmarks, settings, etc.</td>
...
browse the internet without integration of Google</td>
<td valign="top"><font color="red"><strong>Microsoft Edge, Google Chrome, Apple Safari</strong></font></td></tr>
...
send and receive emails, managing contacts (CardDAV) and manage calendars and tasks (CalDAV, ICS)</td>
...
play video or audio from files or streams, supports dual subtitles</td>
<td valign="top"><font color="red"><strong>Microsoft Media Player, Winamp, QuickTime, DVD Player, iTunes</strong></font></td></tr>
...
play video or audio from files or streams, including info and movie posters from TMDb</td>
<td valign="top"><font color="red"><strong>Microsoft Media Player, Winamp, QuickTime, DVD Player, iTunes</strong></font></td></tr>
...
send and receive anonymously the cryptocurrency Dash</td>
...
send and receive anonymously the cryptocurrency Firo</td>
<td valign="top"><font color="red"><strong>PayPal, American Express, Visa, Mastercard, Bitcoin</strong></font></td></tr>
...
send and receive anonymously the cryptocurrency Beldex</td>
<td valign="top"><font color="red"><strong>PayPal, American Express, Visa, Mastercard, Bitcoin</strong></font></td></tr>
...
send and receive anonymously the cryptocurrency Monero</td>
<td valign="top"><font color="red"><strong>PayPal, American Express, Visa, Mastercard, Bitcoin</strong></font></td></tr>
</table>
